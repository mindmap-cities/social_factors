...
```{r, echo=FALSE}
soc_ROTTERDAM_0 <- data.frame(id = ROTTERDAM_0$id )
soc_ROTTERDAM_1 <- data.frame(id = ROTTERDAM_1$id )
soc_ROTTERDAM_2 <- data.frame(id = ROTTERDAM_2$id )
soc_ROTTERDAM_3 <- data.frame(id = ROTTERDAM_3$id )
...
**R script**:  
```{r, echo=TRUE}
table(ROTTERDAM_3$e6_EHAPPY54) 

soc_ROTTERDAM_3$soc_sp_religious_3 <- ifelse(ROTTERDAM_3$e6_EHAPPY54==0, 0L,
                                  ifelse(ROTTERDAM_3$e6_EHAPPY54==1, 1L, NA))

table(soc_ROTTERDAM_3$soc_sp_religious_3) 
```
### **Variable label**:  Religious participation 
...
**Harmonization status**:   complete    
**Harmonization comment**:  Study-specific categories: living in a serviceflat, home for the elderly and nursing home are coded under 1|Lives in a nursing home
**R script**:  
```{r, echo=TRUE}
table(ROTTERDAM_1$e4_dihome) 

soc_ROTTERDAM_1$soc_res_indep_1 <- ifelse(ROTTERDAM_1$e4_dihome==1, 0L,
                                    ifelse(ROTTERDAM_1$e4_dihome==2 |ROTTERDAM_1$e4_dihome==3|  ROTTERDAM_1$e4_dihome==4,1L, NA))

table(soc_ROTTERDAM_1$soc_res_indep_1) 
...
**R script**:  
```{r, echo=TRUE}
table(ROTTERDAM_2$e5_EIHOME) 

soc_ROTTERDAM_2$soc_res_indep_2 <- ifelse(ROTTERDAM_2$e5_EIHOME==1, 0L,
                                    ifelse(ROTTERDAM_2$e5_EIHOME==2 |  ROTTERDAM_2$e5_EIHOME==3|ROTTERDAM_2$e5_EIHOME==4,1L, NA))

table(soc_ROTTERDAM_2$soc_res_indep_2) 
...
**R script**:  
```{r, echo=TRUE}
table(ROTTERDAM_3$e6_EIHOME) 

soc_ROTTERDAM_3$soc_res_indep_3 <- ifelse(ROTTERDAM_3$e6_EIHOME==1, 0L, 
                                    ifelse(ROTTERDAM_3$e6_EIHOME==2 |ROTTERDAM_3$e6_EIHOME==3|ROTTERDAM_3$e6_EIHOME==4,1L, NA))

table(soc_ROTTERDAM_3$soc_res_indep_3) 
