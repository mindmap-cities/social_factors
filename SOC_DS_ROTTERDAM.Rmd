...
opal.assign.table.tibble(erasmus_opal, 'RSII_MINDMAP_13082019_visit1','ROTTERDAM.RSII_MINDMAP_13082019_visit1', variables =list('e4_dihome'))
ROTTERDAM_1 <- opal.execute(erasmus_opal,'RSII_MINDMAP_13082019_visit1')

opal.assign.table.tibble(erasmus_opal, 'RSII_MINDMAP_18102019_visit2','ROTTERDAM.RSII_MINDMAP_18102019_visit2', variables =list( 'e5_EIHOME'))
...
**Harmonization comment**:  Study specific variable only asks about visiting a church, mosque or tempel.  
**R script**:  
```{r, echo=TRUE}
table(RSII_MINDMAP_18102019_visit3$e6_EHAPPY54) 

ROTTERDAM_3$soc_sp_religious_3 <- ifelse(RSII_MINDMAP_18102019_visit3$e6_EHAPPY54==0, 0L
                                    ifelse(RSII_MINDMAP_18102019_visit3$e6_EHAPPY54==1, 1L, NA))

table(ROTTERDAM_3$soc_sp_religious_3) 
summary(ROTTERDAM_3$soc_sp_religious_3)
```
### **Variable label**:  Religious participation 
...
**Harmonization status**:   complete    
**Harmonization comment**:  Specific study variable's category 'other' was recoded as 'lives independently' (2participants). 
**R script**:  
```{r, echo=TRUE}
table(RSII_MINDMAP_13082019_visit1$e4_dihome) 

ROTTERDAM_1$soc_res_indep_1 <- ifelse(RSII_MINDMAP_13082019_visit1$e4_dihome==1, 0L
                                    ifelse(RSII_MINDMAP_13082019_visit1$e4_dihome==2 &  RSII_MINDMAP_13082019_visit1$e4_dihome==5,1L, NA))

table(ROTTERDAM_1$soc_res_indep_1) 
summary(ROTTERDAM_1$soc_res_indep_1) 
```
### **Variable label**:  Residence independence     
...
**Harmonization status**:   complete    
**Harmonization comment**:  Specific study variable's category 'other' was recoded as 'lives independently' (11 participants). 
**R script**:  
```{r, echo=TRUE}
table(RSII_MINDMAP_18102019_visit2$e5_EIHOME) 

ROTTERDAM_2$soc_res_indep_2 <- ifelse(RSII_MINDMAP_18102019_visit2$e5_EIHOME==1, 0L
                                    ifelse(RSII_MINDMAP_18102019_visit2$e5_EIHOME==2 &  RSII_MINDMAP_18102019_visit2$e5_EIHOME==5,1L, NA))

table(ROTTERDAM_2$soc_res_indep_2) 
summary(ROTTERDAM_2$soc_res_indep_2) 
```
### **Variable label**:  Residence independence     
...
**Harmonization status**:   complete    
**Harmonization comment**:  Specific study variable's category 'other' was recoded as 'lives independently' (0 participants).   
**R script**:  
```{r, echo=TRUE}
table(RSII_MINDMAP_18102019_visit3$e6_EIHOME) 

ROTTERDAM_3$soc_res_indep_3 <- ifelse(RSII_MINDMAP_18102019_visit3$e6_EIHOME==1, 0L
                                    ifelse(RSII_MINDMAP_18102019_visit3$e6_EIHOME==2 &  RSII_MINDMAP_18102019_visit3$e6_EIHOME==5,1L, NA))

table(ROTTERDAM_3$soc_res_indep_3) 
summary(ROTTERDAM_3$soc_res_indep_3) 
```
### **Variable label**:  Residence independence     
