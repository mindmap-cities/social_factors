...
```{r, echo=FALSE}
soc_HAPIEE_CZ_0 <- data.frame(id = HAPIEE_W1$id )
soc_HAPIEE_CZ_1 <- data.frame(id = HAPIEE_W2$id )
```
...
**R script**:  
```{r, echo=TRUE}
#w2chldno exists but it is not loaded in Obiba (only w2child_lt)
...
soc_HAPIEE_CZ_0$soc_sn_freq_friends_inperson_0 <-  ifelse(HAPIEE_W1$p58=='1',2L, 
                                                     ifelse(HAPIEE_W1$p58=='2' | HAPIEE_W1$p58=='3',3L,
                                                       ifelse(HAPIEE_W1$p58 =='4',4L, 
                                                         ifelse(HAPIEE_W1$p58 =='5' | HAPIEE_W1$p58 =='5',5L,NA))))

table(soc_HAPIEE_CZ_0$soc_sn_freq_friends_inperson_0) 
``` 
### **Variable label**:   In-person contact frequency with friends        
...
soc_HAPIEE_CZ_0$soc_sn_freq_relatives_0 <-  ifelse(HAPIEE_W1$p57=='1'|HAPIEE_W1$p57=='2',1L, 
                                                     ifelse(HAPIEE_W1$p57=='3',2L,
                                                       ifelse(HAPIEE_W1$p57 =='4',3L, 
                                                         ifelse(HAPIEE_W1$p57 =='5' | HAPIEE_W1$p57 =='6',4L,NA))))
table(soc_HAPIEE_CZ_0$soc_sn_freq_relatives_0)
...
table(HAPIEE_W1$p55) #1 yes, a member  2 no

soc_HAPIEE_CZ_0$soc_sp_general_0 <- ifelse(HAPIEE_W1$p55=='1',1L, 
                                                    ifelse(HAPIEE_W1$p55 =='2',0L, NA))

table(soc_HAPIEE_CZ_0$soc_sp_general_0)
...
**Variable description**:  Indicator of whether the participant is socially i.e. no/ low social network and no participation in an association (any type, including religious organization and volunteering).         
**Value type**:  integer  
**Variable unit**:    
**Category coding**:  
