...
**Harmonization comment**:  SN_CHILDBIO_NB_COM, SN_CHILD_NB_COM 
**R script**:  
```{r, echo=TRUE}
...
**Harmonization status**:  complete  
**Harmonization comment**:  SN_CHILD_NB_COF1, SN_CHILDBIO_NB_COF1 
**R script**:  
```{r, echo=TRUE}
#This is where the R-script will be written
...
**Harmonization status**:  complete  
**Harmonization comment**:  SN_FRND_NB_COM 
**R script**:  
```{r, echo=TRUE}
#This is where the R-script will be written
...
**Harmonization status**:  complete  
**Harmonization comment**:   SN_FRND_NB_COF1
**R script**:  
```{r, echo=TRUE}
#This is where the R-script will be written
...
**Harmonization status**:  impossible  
**Harmonization comment**:  Study-specific variable SN_NEIBR_NB_COM is an indicator of the number of neighbours of the participant.  
**R script**:  
```{r, echo=TRUE}
...
**Harmonization status**:  impossible  
**Harmonization comment**:  Study-specific variable SN_NEIBR_NB_COF1 is an indicator of the number of neighbours of the participant.   
**R script**:  
```{r, echo=TRUE}
