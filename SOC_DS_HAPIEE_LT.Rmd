...
#HAPIEE_W2 
opal.assign.table.tibble(erasmus_opal, 'HAPIEE_W2', 'HAPIEE.HAPIEE_W2',variables = list('country','w2chldno_lt','p58_lt','p57_lt','p55_lt','w2child_lt'))
...
soc_HAPIEE_LT_0$soc_sn_num_children_0 <- ifelse(HAPIEE_W2$w2child_lt==2,0L, as.integer(HAPIEE_W2$w2chldno_lt))
...
soc_HAPIEE_LT_0$soc_sn_children_rank_0 <- ifelse(HAPIEE_W2$w2child_lt=='2',0L, 
...
soc_HAPIEE_LT_0$soc_sn_freq_friends_inperson_0 <-  ifelse(HAPIEE_W2$p58_lt=='1'|HAPIEE_W2$p58_lt=='2' ,2L, 
                                                     ifelse(HAPIEE_W2$p58_lt=='3',3L,
                                                       ifelse(HAPIEE_W2$p58_lt =='4',4L, 
                                                         ifelse(HAPIEE_W2$p58_lt =='5' | HAPIEE_W2$p58_lt =='6',5L,NA))))
...
```{r, echo=TRUE}
#p57_lt
#s68 and s67 are missing from LT set to I cannot use these to calculate DAILY contact
