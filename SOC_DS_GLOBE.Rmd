...
**R script**:  
```{r, echo=TRUE}
soc_GLOBE_4$soc_sn_freq_friends_inperson_4 <- ifelse(GLOBE2014$G14v45==1|GLOBE2014$G14v45==2|GLOBE2014$G14v45==3, 1L, 
                                                ifelse(GLOBE2014$G14v45==4, 2L,ifelse(GLOBE2014$G14v45==5, 3L,NA)))
...
soc_GLOBE_4$soc_sn_freq_friends_4 <- ifelse(GLOBE2014$G14v46==1|GLOBE2014$G14v46==2|GLOBE2014$G14v46==3, 1L, 
                                                 ifelse(GLOBE2014$G14v46==4, 2L,ifelse(GLOBE2014$G14v46==5, 3L,NA)))
...
soc_GLOBE_4$soc_sn_freq_nbhs_4 <- ifelse(GLOBE2014$G14v55==1|GLOBE2014$G14v55==2|GLOBE2014$G14v55==3, 1L, 
                                                 ifelse(GLOBE2014$G14v55==4, 2L,ifelse(GLOBE2014$G14v55==5, 3L,NA)))
```
### **Variable label**:   Contact frequency with neighbours        
...
table(soc_GLOBE_4$soc_sn_num_relatives_4,useNA = "always")
```
### **Variable label**:   Network size of relatives      
...
soc_GLOBE_4$soc_sn_freq_close_relatives_4 <- ifelse(GLOBE2014$G14v40==1|GLOBE2014$G14v40==2|GLOBE2014$G14v40==3, 1L, 
                                                 ifelse(GLOBE2014$G14v40==4, 2L,ifelse(GLOBE2014$G14v40==5, 3L,NA)))
...
soc_GLOBE_4$soc_sn_freq_relatives_4 <- ifelse(GLOBE2014$G14v40==1|GLOBE2014$G14v40==2|GLOBE2014$G14v40==3, 1L, 
                                                 ifelse(GLOBE2014$G14v40==4, 2L,ifelse(GLOBE2014$G14v40==5, 3L,NA)))
...
**Harmonization status**:  complete   
**Harmonization comment**: 97% of respondents were categorized the same (as isolated or not isoldated) using either i) study available DataSchema social network variables (children, friends, neighbours, relatives) in addition to the general participation variable or ii) study available DataSchema social network - contact frequency variables (friends, neighbours, relatives, close relatives) in addition to the general participation variable. Approach ii) was chosen for the transformation of this DataSchema.       
**R script**:  
```{r, echo=TRUE}

soc_GLOBE_4$soc_sp_isolation_4 <- ifelse((soc_GLOBE_4$soc_sn_freq_friends_inperson_4 ==3 | soc_GLOBE_4$soc_sn_freq_friends_4 ==3 | 
                                          soc_GLOBE_4$soc_sn_freq_nbhs_4 ==3 | soc_GLOBE_4$soc_sn_freq_close_relatives_4 ==3 |soc_GLOBE_4$soc_sn_freq_relatives_4==3 ) & 
                                           soc_GLOBE_4$soc_sp_general_4 == 0,1L,
                                 ifelse((soc_GLOBE_4$soc_sn_freq_friends_inperson_4 >=1 | soc_GLOBE_4$soc_sn_freq_friends_4 >= 1 | soc_GLOBE_4$soc_sn_freq_nbhs_4 >= 1 | 
                                          soc_GLOBE_4$soc_sn_freq_close_relatives_4 >= 1 | soc_GLOBE_4$soc_sn_freq_relatives_4 >= 1) & soc_GLOBE_4$soc_sp_general_4 == 1, 0L, NA ))
