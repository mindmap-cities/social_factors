...
**Code** | **Category Label**  
------------- | -------------  
0 |  Was not the victim of a crime
1 |  Was the victim of a crime 
...
1 |  Experienced financial problems  
...
1 |  Experienced relationship problems
...
1 |  Divorced/ had relationship breakup  
...
1 |  Experienced illness of family member 
...
1 |  Experienced death of partner/spouse 
...
1 |  Experienced death of child/family member/friend  
...
**Variable description**:  Indicator of the number of years that participant has lived in the neighbourhood.  
**Value type**:  integer  
**Variable unit**:   
**Category coding**:  
...
**Variable description**:  Indicator of the number of years that participant has lived in current home/address.    
**Value type**:  integer  
**Variable unit**:   
**Category coding**:  
...
1 |  Wants to move out of neighbourhood
