...
# LASA1B
opal.assign.table.tibble(erasmus_opal, 'LASA1B', 'LASA.LASA1B',variables = list('blo1','blo4','blo7','blo8','blo11','bsocp04','bsocp14','bsocp15','bsocp16','bsocp17','bsocp18','bsocp19','bsocp20','bsocp21','bsocp23','bsocp24','bsocp31','bsocp43','bsocp44','bsocp46','bsocp48','bsocp55','bsocp57','bsocpyn','bmoved','bhindep','bhoustyp')) 
...
**R script**:  
```{r, echo=TRUE}
table(LASA1B_socialnet$rec_emo_conf1, useNA="always")
table(LASA1B_socialnet$rec_emo_conf2, useNA="always")
table(LASA1B_socialnet$rec_emo_conf3, useNA="always")
...
table(do.call( pmax, c(LASA1B_socialnet[12:14], na.rm=T )), useNA="always")
...
table(do.call( pmax, c(LASA1C_socialnet[12:14], na.rm=T )), useNA="always")
...
soc_LASA1_0$soc_sp_religious_0 <- ifelse(LASA1B$bsocpyn==1|LASA1B$bsocp04==0|LASA1B$bsocp17==1,0L, ifelse(LASA1B$bsocp17 ==2,1L, NA))
...
soc_LASA1_1$soc_le_dfam_1 <- ifelse(LASA1C$cfadied =='2' | LASA1C$cmodied =='2'| LASA1C$cbrodied =='2'| LASA1C$csisdied =='2'| LASA1C$csondied =='2'| LASA1C$cdaudied =='2'| LASA1C$cgcdied =='2',1L, 
                                     ifelse((LASA1C$cfadied =='1' | LASA1C$cfadied =='-2') & (LASA1C$cmodied =='1'|LASA1C$cmodied=='-2' ) & (LASA1C$cbrodied =='1'| (LASA1C$cbrodied =='-2')& (LASA1C$csisdied =='1'|LASA1C$csisdied =='-2' )& (LASA1C$csondied =='1'| LASA1C$csondied =='-2')& (LASA1C$cdaudied =='1'|LASA1C$cdaudied =='-2' )& (LASA1C$cgcdied =='1'| LASA1C$cgcdied =='-2'),0L, NA))

table(soc_LASA1_1$soc_le_dfam_1,useNA="always") 
