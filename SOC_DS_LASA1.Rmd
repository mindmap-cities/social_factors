...
LASA1B_socialnet <- opal.execute(erasmus_opal,'LASA1B_socialnet') %>% as_tibble %>% arrange(id)
...
LASA1B_extradata2 <- opal.execute(erasmus_opal,'LASA1B_extradata2') %>% as_tibble %>% arrange(id)
...
LASA1C_socialnet<- opal.execute(erasmus_opal,'LASA1C_socialnet') %>% as_tibble %>% arrange(id)
...
LASA1C_extradata2 <- opal.execute(erasmus_opal,'LASA1C_extradata2') %>% as_tibble %>% arrange(id)
...
LASA1D_socialnet <- opal.execute(erasmus_opal,'LASA1D_socialnet') %>% as_tibble %>% arrange(id)
...
LASA1D_extradata2 <- opal.execute(erasmus_opal,'LASA1D_extradata2') %>% as_tibble %>% arrange(id)
...
LASA1E_socialnet <- opal.execute(erasmus_opal,'LASA1E_socialnet') %>% as_tibble %>% arrange(id)
...
LASA1E_extradata2 <- opal.execute(erasmus_opal,'LASA1E_extradata2') %>% as_tibble %>% arrange(id)
...
LASA1F_socialnet <- opal.execute(erasmus_opal,'LASA1F_socialnet') %>% as_tibble %>% arrange(id)
...
LASA1F_extradata2 <- opal.execute(erasmus_opal,'LASA1F_extradata2') %>% as_tibble %>% arrange(id)
...
LASA1G_socialnet <- opal.execute(erasmus_opal,'LASA1G_socialnet') %>% as_tibble %>% arrange(id)
...
LASA1G_extradata2 <- opal.execute(erasmus_opal,'LASA1G_extradata2') %>% as_tibble %>% arrange(id)
...
LASA1H_socialnet <- opal.execute(erasmus_opal,'LASA1H_socialnet') %>% as_tibble %>% arrange(id)
...
LASA1H_extradata2 <- opal.execute(erasmus_opal,'LASA1H_extradata2') %>% as_tibble %>% arrange(id)

LASA1B <-merge(LASA1B, LASA1B_extradata2,  by="id", all = TRUE) %>% as_tibble %>% arrange(id)
LASA1B <-merge(LASA1B, LASA1B_socialnet,   by="id", all = TRUE) %>% as_tibble %>% arrange(id)

LASA1C <-merge(LASA1C, LASA1C_extradata2,  by="id", all = TRUE) %>% as_tibble %>% arrange(id)
LASA1C <-merge(LASA1C, LASA1C_socialnet,   by="id", all = TRUE) %>% as_tibble %>% arrange(id)

LASA1D <-merge(LASA1D, LASA1D_extradata2,  by="id", all = TRUE) %>% as_tibble %>% arrange(id)
LASA1D <-merge(LASA1D, LASA1D_socialnet,   by="id", all = TRUE) %>% as_tibble %>% arrange(id)

LASA1E <-merge(LASA1E, LASA1E_extradata2,  by="id", all = TRUE) %>% as_tibble %>% arrange(id)
LASA1E <-merge(LASA1E, LASA1E_socialnet,   by="id", all = TRUE) %>% as_tibble %>% arrange(id)

LASA1F <-merge(LASA1F, LASA1F_extradata2,  by="id", all = TRUE) %>% as_tibble %>% arrange(id)
LASA1F <-merge(LASA1F, LASA1F_socialnet,   by="id", all = TRUE) %>% as_tibble %>% arrange(id)

LASA1G <-merge(LASA1G, LASA1G_extradata2,  by="id", all = TRUE) %>% as_tibble %>% arrange(id)
LASA1G <-merge(LASA1G, LASA1G_socialnet,   by="id", all = TRUE) %>% as_tibble %>% arrange(id)

LASA1H <-merge(LASA1H, LASA1H_extradata2,  by="id", all = TRUE) %>% as_tibble %>% arrange(id)
LASA1H <-merge(LASA1H, LASA1H_socialnet,   by="id", all = TRUE) %>% as_tibble %>% arrange(id)


```
## Assign participant id as first column of your harmonized dataframes
```{r, echo=FALSE}
soc_LASA1_0 <- data.frame(id = LASA1B$id) %>% as_tibble %>% arrange(id)
soc_LASA1_1 <- data.frame(id = LASA1C$id) %>% as_tibble %>% arrange(id)
soc_LASA1_2 <- data.frame(id = LASA1D$id) %>% as_tibble %>% arrange(id)
soc_LASA1_3 <- data.frame(id = LASA1E$id) %>% as_tibble %>% arrange(id)
soc_LASA1_4 <- data.frame(id = LASA1F$id) %>% as_tibble %>% arrange(id)
soc_LASA1_5 <- data.frame(id = LASA1G$id) %>% as_tibble %>% arrange(id)
soc_LASA1_6 <- data.frame(id = LASA1H$id) %>% as_tibble %>% arrange(id)
```
...
soc_LASA1_3$soc_sp_cultural_edu_3 <- ifelse(LASA1E$esocp23 ==2 | LASA1E$esocp55 ==2 ,1L,
                                            ifelse((LASA1E$esocpyn ==1 | LASA1E$esocp10 ==0)| 
                                                   (LASA1E$esocp23 ==1 & LASA1E$esocp55 ==1), 0L, NA))
...
**R script**:  
```{r, echo=TRUE}
soc_LASA1_4$soc_sp_cultural_edu_4 <- ifelse(LASA1F$fsocp23 ==2  | LASA1F$fsocp55 ==2 ,1L,  
                                     ifelse((LASA1F$fsocpyn ==1 | LASA1F$fsocp10 ==0)| 
                                            (LASA1F$fsocp23 ==1 & LASA1F$fsocp55 ==1),0L, NA))
...
soc_LASA1_5$soc_sp_cultural_edu_5 <-  ifelse(LASA1G$gsocp23 ==2 | LASA1G$gsocp55 ==2 ,1L,
                                      ifelse((LASA1G$gsocpyn==1 | LASA1G$gsocp10 ==0)| 
                                             (LASA1G$gsocp23==1 & LASA1G$gsocp55 ==1),0L, NA))
...
soc_LASA1_6$soc_sp_cultural_edu_6<- ifelse(LASA1H$HSOCP23 ==2 | LASA1H$HSOCP55 ==2 ,1L,
                                    ifelse((LASA1H$HSOCPYN ==1| LASA1H$HSOCP10 ==0)|
                                          (LASA1H$HSOCP23 ==1 & LASA1H$HSOCP55 ==1),0L, NA))
...
**R script**:  
```{r, echo=TRUE}
soc_LASA1_0$soc_sp_cul_edu_soc_0 <- ifelse(  LASA1B$bsocp14==2 | 
                                             LASA1B$bsocp20==2 | 
                                             LASA1B$bsocp21==2 |  
                                             LASA1B$bsocp23==2 |
                                             LASA1B$bsocp55==2 ,1L, 
                                    ifelse( LASA1B$bsocpyn==1  | 
                                                  ((LASA1B$bsocp01==0 | LASA1B$bsocp14 ==1)&
                                                   (LASA1B$bsocp07 ==0|LASA1B$bsocp20== 1) & 
                                                   (LASA1B$bsocp08 ==0|LASA1B$bsocp21== 1) &  
                                                   (LASA1B$bsocp10 ==0|LASA1B$bsocp23== 1))& 
                                                   LASA1B$bsocp55== 1  ,0L, NA))
       
table(soc_LASA1_0$soc_sp_cul_edu_soc_0, useNA="always")
table(LASA1B$bsocp01, LASA1B$bsocp20, useNA="always")
```
### **Variable label**:  Cultural, educational and social participation       
...
soc_LASA1_1$soc_sp_cul_edu_soc_1 <- ifelse(LASA1C$csocp14 ==2|
                                           LASA1C$csocp20==2 | 
                                           LASA1C$csocp21==2 |  
                                           LASA1C$csocp23==2 | 
                                           LASA1C$csocp55==2 ,1L, 
                                    ifelse((LASA1C$csocpyn==1 | 
                                            ((LASA1C$csocp01 ==0| LASA1C$csocp14==1  )&
                                            (LASA1C$csocp07 ==0| LASA1C$csocp20==1  )&
                                            (LASA1C$csocp08 ==0| LASA1C$csocp21==1  )&
                                            (LASA1C$csocp10 ==0| LASA1C$csocp23==1  ))|
                                            LASA1C$csocp55==1),0L, NA))
...
soc_LASA1_2$soc_sp_cul_edu_soc_2 <- ifelse(LASA1D$dsocp14==2 | 
                                           LASA1D$dsocp20==2 |
                                           LASA1D$dsocp21==2 |  
                                           LASA1D$dsocp23==2 | 
                                           LASA1D$dsocp55==2 ,1L, 
                                           ifelse(LASA1D$dsocpyn==1 | 
                                                  ((LASA1D$dsocp01 ==0|LASA1D$dsocp14== 1)& 
                                                  (LASA1D$dsocp07 ==0|LASA1D$dsocp20== 1)&
                                                  (LASA1D$dsocp08 ==0|LASA1D$dsocp21== 1)&
                                                  (LASA1D$dsocp10 ==0|LASA1D$dsocp23== 1))|
                                                   LASA1D$dsocp55==1 ,0L, NA))
...
soc_LASA1_3$soc_sp_cul_edu_soc_3 <- ifelse(LASA1E$esocp14 ==2 |
                                           LASA1E$esocp20 ==2 | 
                                           LASA1E$esocp21 ==2 |  
                                           LASA1E$esocp23 ==2 | LASA1E$esocp55==2 ,1L, 
                                    ifelse(LASA1E$esocpyn==1 |
                                              ((LASA1E$esocp01 ==0|LASA1E$esocp14 ==1)&
                                              (LASA1E$esocp07 ==0 |LASA1E$esocp20==1)&
                                              (LASA1E$esocp08 ==0 |LASA1E$esocp21==1)&
                                              (LASA1E$esocp10 ==0 |LASA1E$esocp23==1))|
                                               LASA1E$esocp55==1, 0L, NA))
...
soc_LASA1_4$soc_sp_cul_edu_soc_4 <- ifelse(LASA1F$fsocp14 ==2 | 
                                           LASA1F$fsocp20==2  | 
                                           LASA1F$fsocp21==2  | 
                                           LASA1F$fsocp23==2  | 
                                           LASA1F$fsocp55==2 ,1L, 
                                     ifelse(LASA1F$fsocpyn==1 | 
                                            ((LASA1F$fsocp01 ==0|LASA1F$fsocp14 ==1)&
                                            (LASA1F$fsocp07  ==0 |LASA1F$fsocp20 ==1)&
                                            (LASA1F$fsocp08  ==0 |LASA1F$fsocp21 ==1)&
                                            (LASA1F$fsocp10  ==0 |LASA1F$fsocp23 ==1))
                                                  |LASA1F$fsocp55==1,0L, NA))
...
soc_LASA1_5$soc_sp_cul_edu_soc_5 <- ifelse(LASA1G$gsocp14 ==2 |
                                             LASA1G$gsocp20==2 |
                                             LASA1G$gsocp21==2 | 
                                             LASA1G$gsocp23==2 | 
                                             LASA1G$gsocp55==2 ,1L, 
                                    ifelse(LASA1G$gsocpyn==1 |
                                                     ((LASA1G$gsocp01 ==0|LASA1G$gsocp14==1) &
                                                     (LASA1G$gsocp07 ==0|LASA1G$gsocp20==1) & 
                                                     (LASA1G$gsocp08 ==0|LASA1G$gsocp21==1) &
                                                     (LASA1G$gsocp10 ==0|LASA1G$gsocp23==1))| 
                                                       LASA1G$gsocp55==1,0L, NA))
...
soc_LASA1_6$soc_sp_cul_edu_soc_6 <- ifelse(LASA1H$HSOCP14 ==2 | 
                                             LASA1H$HSOCP20==2 | 
                                             LASA1H$HSOCP21==2 |  
                                             LASA1H$HSOCP23==2 |
                                             LASA1H$HSOCP55==2 ,1L, 
                                           ifelse(LASA1H$HSOCPYN==1 | 
                                                     ((LASA1H$HSOCP01==0 | LASA1H$HSOCP14==1) & 
                                                     (LASA1H$HSOCP07 ==0 | LASA1H$HSOCP20==1) & 
                                                     (LASA1H$HSOCP08 ==0 | LASA1H$HSOCP21==1) & 
                                                     (LASA1H$HSOCP10 ==0 | LASA1H$HSOCP23==1))| 
                                                       LASA1H$HSOCP55==1,0L, NA))
...
soc_LASA1_0$soc_sp_volunteer_0 <- ifelse(LASA1B$bsocp31 ==2,1L, 
                                  ifelse(LASA1B$bsocp31 ==1 |LASA1B$bsocpyn==1,0L, NA))

table(soc_LASA1_0$soc_sp_volunteer_0, useNA="always") 
...
soc_LASA1_1$soc_sp_volunteer_1 <- ifelse(LASA1C$csocp31 ==2,1L, 
                                         ifelse(LASA1C$csocp31 ==1|LASA1C$csocpyn==1,0L, NA))
...
soc_LASA1_2$soc_sp_volunteer_2 <- ifelse(LASA1D$dsocp31 ==2,1L, 
                                         ifelse(LASA1D$dsocp31 ==1|LASA1D$dsocpyn==1,0L, NA))
...
soc_LASA1_3$soc_sp_volunteer_3 <- ifelse(LASA1E$esocp31 ==2,1L, 
                                  ifelse(LASA1E$esocp31 ==1 |LASA1E$esocpyn==1,0L, NA))
...
soc_LASA1_4$soc_sp_volunteer_4 <- ifelse(LASA1F$fsocp31 ==2,1L, 
                                  ifelse(LASA1F$fsocp31 ==1||LASA1F$fsocpyn==1,0L, NA))
...
soc_LASA1_5$soc_sp_volunteer_5 <- ifelse(LASA1G$gsocp31 ==2,1L, 
                                  ifelse(LASA1G$gsocp31 ==1|LASA1G$gsocpyn==1,0L, NA))
...
**R script**:  
```{r, echo=TRUE}
table(LASA1H$HSOCP31, LASA1H$HSOCPYN, useNA="always")  
summary(LASA1H$HSOCP31)
soc_LASA1_6$soc_sp_volunteer_6 <- ifelse(LASA1H$HSOCP31 ==2,1L, 
                                  ifelse(LASA1H$HSOCP31 ==1|LASA1H$HSOCPYN==1,0L, NA))
...
soc_LASA1_0$soc_sp_pol_0 <- ifelse(LASA1B$bsocp15==2   |LASA1B$bsocp16==2,1L, 
                            ifelse(LASA1B$bsocpy==1    |
                                   ((LASA1B$bsocp02==0 |LASA1B$bsocp15 ==1)&
                                   (LASA1B$bsocp03==0  |LASA1B$bsocp16 ==1)),0L, NA))
...
soc_LASA1_1$soc_sp_pol_1 <- ifelse(LASA1C$csocp15 ==2 |LASA1C$csocp16 ==2,1L, 
                            ifelse(LASA1C$csocpyn ==1|
                                 ((LASA1C$csocp02 ==0|LASA1C$csocp15 ==1) &
                                  (LASA1C$csocp03 ==0|LASA1C$csocp16 ==1)),0L, NA))
...
soc_LASA1_2$soc_sp_pol_2 <- ifelse(LASA1D$dsocp15 ==2 | LASA1D$dsocp16 ==2,1L, 
                            ifelse((LASA1D$dsocpyn ==1|
                                    (LASA1D$dsocp02==0||LASA1D$dsocp15 ==1)&
                                    (LASA1D$dsocp03==0| LASA1D$dsocp16 ==1)) ,0L, NA))
...
soc_LASA1_3$soc_sp_pol_3 <- ifelse(LASA1E$esocp15 ==2 | LASA1E$esocp16 ==2,1L, 
                             ifelse(LASA1E$esocpyn ==1|
                                               ((LASA1E$esocp02==0 |LASA1E$esocp15 ==1)&
                                                (LASA1E$esocp03==0 |LASA1E$esocp16 ==1)),0L, NA))
...
table(soc_LASA1_0$soc_sp_general_0, useNA = "always") 
...
table(soc_LASA1_1$soc_sp_general_1, useNA = "always") 
...
table(soc_LASA1_2$soc_sp_general_2, useNA = "always") 
...
table(soc_LASA1_3$soc_sp_general_3, useNA = "always") 
...
```{r, echo=TRUE}
#bsocp44
table(LASA1B$bsocp44, useNA = "always") 
...
table(soc_LASA1_0$soc_sp_nosafety_0 , useNA = "always") 
...
**Harmonization status**:  complete    
**Harmonization comment**:   Study specific items 1.visiting an organization for a hobby or 2. studying a hobby were used. 
**R script**:  
```{r, echo=TRUE}
table(LASA1B$bsocp24, useNA="always")  #do you visit an organization for hobby 
table(LASA1B$bsocp57, useNA="always") #do you study a hobby

soc_LASA1_0$soc_sp_hobby_0 <- ifelse(LASA1B$bsocpyn==1&LASA1B$bsocp55==1, 0L, 
                                     ifelse (LASA1B$bsocp24 =='2' | LASA1B$bsocp57 =='1',1L, 
                                     ifelse((LASA1B$bsocp24 =='1' & LASA1B$bsocp57 !='1')| 
                                            (LASA1B$bsocp57 =='0' & LASA1B$bsocp24 !='2'),0L, NA)))
...
soc_LASA1_1$soc_sp_hobby_1 <- ifelse(LASA1C$csocpyn==1 &LASA1C$csocp55==1, 0L, 
                                     ifelse (LASA1C$csocp24 =='2' | LASA1C$csocp57 =='1',1L,
                                             ifelse((LASA1C$csocp24 =='1' & LASA1C$csocp57 !='1')|
                                                    (LASA1C$csocp57 =='1'& LASA1C$csocp24 !='2')
                                                    ,0L, NA)))
...
soc_LASA1_2$soc_sp_hobby_2 <- ifelse(LASA1D$dsocpyn==1 &LASA1D$dsocp55==1, 0L, 
                                     ifelse (LASA1D$dsocp24 =='2' | LASA1D$dsocp57 =='1',1L, ifelse((LASA1D$dsocp24 =='1' & LASA1D$dsocp57 !='1')| (LASA1D$dsocp57 =='1'&LASA1D$dsocp24 !='2'),0L, NA)))
...
soc_LASA1_3$soc_sp_hobby_3 <- ifelse(LASA1E$esocpyn==1 , 0L, 
                                     ifelse (LASA1E$esocp24 =='2',1L , ifelse(LASA1E$esocp24 =='1',0L, NA)))
...
soc_LASA1_4$soc_sp_hobby_4 <- ifelse(LASA1F$fsocpyn==1 &LASA1F$fsocp55==1, 0L, 
                                     ifelse (LASA1F$fsocp24 =='2' | LASA1F$fsocp57 =='1',1L, ifelse((LASA1F$fsocp24 =='1' & LASA1F$fsocp57 !='1')| (LASA1F$fsocp57 =='1'&LASA1F$fsocp24 !='2'),0L, NA)))
...
soc_LASA1_5$soc_sp_hobby_5 <- ifelse(LASA1G$gsocpyn==1 &LASA1G$gsocp55==1, 0L, 
                                     ifelse (LASA1G$gsocp24 =='2' | LASA1G$gsocp57 =='1',1L, ifelse((LASA1G$gsocp24 =='1' & LASA1G$gsocp57 !='1')| (LASA1G$gsocp57 =='1'&LASA1G$gsocp24 !='2'),0L, NA)))
...
soc_LASA1_6$soc_sp_hobby_6 <- ifelse(LASA1H$HSOCPYN==1 &LASA1H$HSOCP55==1, 0L, 
                                     ifelse (LASA1H$HSOCP24 =='2' | LASA1H$HSOCP57 =='1',1L, ifelse((LASA1H$HSOCP24 =='1' & LASA1H$HSOCP57 !='1')| (LASA1H$HSOCP57 =='1'&LASA1H$HSOCP24 !='2'),0L, NA)))
...
soc_LASA1_0$soc_sp_isolation_0 <- ifelse((soc_LASA1_0$soc_sn_freq_friends_0 == 3 | 
                                      soc_LASA1_0$soc_sn_freq_nbhs_0 ==3 |soc_LASA1_0$soc_sn_freq_close_relatives_0 ==3 |
                                        soc_LASA1_0$soc_sn_freq_relatives_0 ==3 |soc_LASA1_0$soc_sn_freq_nonkin_0==3 ) &
                                        soc_LASA1_0$soc_sp_general_0 == 0,1L,
                                 ifelse((soc_LASA1_0$soc_sn_freq_friends_0 >= 1 | soc_LASA1_0$soc_sn_freq_nbhs_0 >= 1 |
                                           soc_LASA1_0$soc_sn_freq_close_relatives_0 >= 1 | soc_LASA1_0$soc_sn_freq_relatives_0 >= 1)
                                        & soc_LASA1_0$soc_sn_freq_nonkin_0 == 1, 0L, NA ))
...
**R script**:  
```{r, echo=TRUE}
soc_LASA1_1$soc_sp_isolation_1 <- ifelse((soc_LASA1_1$soc_sn_freq_friends_1 == 3 | soc_LASA1_1$soc_sn_freq_nbhs_1 ==3 |     
                                          soc_LASA1_1$soc_sn_freq_close_relatives_1 ==3 | soc_LASA1_1$soc_sn_freq_relatives_1 ==3 |soc_LASA1_1$soc_sn_freq_nonkin_1==3 ) & 
                                           soc_LASA1_1$soc_sp_general_1 == 0,1L,
                                 ifelse((soc_LASA1_1$soc_sn_freq_friends_1 >= 1 | soc_LASA1_1$soc_sn_freq_nbhs_1 >= 1 | 
                                           soc_LASA1_1$soc_sn_freq_close_relatives_1 >= 1 | soc_LASA1_1$soc_sn_freq_relatives_1 >= 1) & 
                                          soc_LASA1_1$soc_sn_freq_nonkin_1 == 1, 0L, NA ))
...
**R script**:  
```{r, echo=TRUE}
soc_LASA1_2$soc_sp_isolation_2 <- ifelse((soc_LASA1_2$soc_sn_freq_friends_2 == 3 | soc_LASA1_2$soc_sn_freq_nbhs_2 ==3 | 
                                          soc_LASA1_2$soc_sn_freq_close_relatives_2 ==3 | soc_LASA1_2$soc_sn_freq_relatives_2 ==3 |soc_LASA1_2$soc_sn_freq_nonkin_2==3 ) & 
                                           soc_LASA1_2$soc_sp_general_2 == 0,1L,
                                 ifelse((soc_LASA1_2$soc_sn_freq_friends_2 >= 1 | soc_LASA1_2$soc_sn_freq_nbhs_2 >= 1 | 
                                           soc_LASA1_2$soc_sn_freq_close_relatives_2 >= 1 | soc_LASA1_2$soc_sn_freq_relatives_2 >= 1) & soc_LASA1_2$soc_sn_freq_nonkin_2 == 1, 0L, NA ))
...
**R script**:  
```{r, echo=TRUE}
soc_LASA1_3$soc_sp_isolation_3 <- ifelse((soc_LASA1_3$soc_sn_freq_friends_3 == 3 | soc_LASA1_3$soc_sn_freq_nbhs_3 ==3| 
                                          soc_LASA1_3$soc_sn_freq_close_relatives_3 ==3 | soc_LASA1_3$soc_sn_freq_relatives_3 ==3|soc_LASA1_3$soc_sn_freq_nonkin_3==3 ) & 
                                           soc_LASA1_3$soc_sp_general_3 == 0,1L,
                                 ifelse((soc_LASA1_3$soc_sn_freq_friends_3 >= 1 | soc_LASA1_3$soc_sn_freq_nbhs_3 >= 1 | 
                                          soc_LASA1_3$soc_sn_freq_close_relatives_3 >= 1 | soc_LASA1_3$soc_sn_freq_relatives_3 >= 1) & soc_LASA1_3$soc_sn_freq_nonkin_3 == 1, 0L, NA ))
...
**R script**:  
```{r, echo=TRUE}
soc_LASA1_4$soc_sp_isolation_4 <- ifelse((soc_LASA1_4$soc_sn_freq_friends_4 == 3 | soc_LASA1_4$soc_sn_freq_nbhs_4 ==3 | 
                                          soc_LASA1_4$soc_sn_freq_close_relatives_4 ==3 | soc_LASA1_4$soc_sn_freq_relatives_4 ==3 |soc_LASA1_4$soc_sn_freq_nonkin_4==3 ) & 
                                           soc_LASA1_4$soc_sp_general_4 == 0,1L,
                                 ifelse((soc_LASA1_4$soc_sn_freq_friends_4 >= 1 | soc_LASA1_4$soc_sn_freq_nbhs_4 >= 1 | 
                                          soc_LASA1_4$soc_sn_freq_close_relatives_4 >= 1 | soc_LASA1_4$soc_sn_freq_relatives_4 >= 1) & soc_LASA1_4$soc_sn_freq_nonkin_4 == 1, 0L, NA ))
...
**R script**:  
```{r, echo=TRUE}
soc_LASA1_5$soc_sp_isolation_5 <- ifelse((soc_LASA1_5$soc_sn_freq_friends_5 == 3 | soc_LASA1_5$soc_sn_freq_nbhs_5 ==3 | 
                                          soc_LASA1_5$soc_sn_freq_close_relatives_5 ==3 | soc_LASA1_5$soc_sn_freq_relatives_5 ==3 |soc_LASA1_5$soc_sn_freq_nonkin_5==3 ) & 
                                           soc_LASA1_5$soc_sp_general_5 == 0,1L,
                                 ifelse((soc_LASA1_5$soc_sn_freq_friends_5 >= 1 | soc_LASA1_5$soc_sn_freq_nbhs_5 >= 1 | 
                                          soc_LASA1_5$soc_sn_freq_close_relatives_5 >= 1 | soc_LASA1_5$soc_sn_freq_relatives_5 >= 1) & soc_LASA1_5$soc_sn_freq_nonkin_5 == 1, 0L, NA ))
...
**R script**:  
```{r, echo=TRUE}
soc_LASA1_6$soc_sp_isolation_6 <- ifelse((soc_LASA1_6$soc_sn_freq_friends_6 == 3 | soc_LASA1_6$soc_sn_freq_nbhs_6 ==3 | 
                                          soc_LASA1_6$soc_sn_freq_close_relatives_6 ==3 | soc_LASA1_6$soc_sn_freq_relatives_6 ==3 |soc_LASA1_6$soc_sn_freq_nonkin_6==3 ) & 
                                           soc_LASA1_6$soc_sp_general_6 == 0,1L,
                                 ifelse((soc_LASA1_6$soc_sn_freq_friends_6 >= 1 | soc_LASA1_6$soc_sn_freq_nbhs_6 >= 1 | 
                                          soc_LASA1_6$soc_sn_freq_close_relatives_6 >= 1 | soc_LASA1_6$soc_sn_freq_relatives_6 >= 1) & soc_LASA1_6$soc_sn_freq_nonkin_6 == 1, 0L, NA ))
...
**R script**:  
```{r, echo=TRUE}
soc_LASA1_1$soc_res_num_yrsnbh_1 <- ifelse(LASA1C$cyneigh<0, NA,
...
**R script**:  
```{r, echo=TRUE}
soc_LASA1_1$soc_res_num_yrshome_1 <- ifelse(LASA1C$cyneigh<0, NA,
      as.integer(LASA1C$cyneigh))
