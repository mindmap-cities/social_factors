...
**Harmonization status**:  complete
**Harmonization comment**: Composed of RECORD's items Q24_e_1/2/3 which asks about participation and the DataSchema: soc_sp_religious_0 soc_sp_volunteer_0 soc_sp_pol_0. 
**R script**:  
```{r, echo=TRUE}
