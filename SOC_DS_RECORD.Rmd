...
**Harmonization comment**:   Non-whole numbers that were reported are set as NA. RECORD does not ask what type of child respondent has. 
**R script**:  
```{r, echo=TRUE}
table(RECORD_w1_1$Qm3) # WOW incredible answers data NOT clean, sorry code is not elegant but does the job 
summary(RECORD_w1_1$Qm3)

soc_RECORD_0$soc_sn_num_children_0 <- as.integer(ifelse(RECORD_w1_1$Qm3 == '0', 0, 
                                                   (ifelse (RECORD_w1_1$Qm3 == '1', 1,
                                                        (ifelse (RECORD_w1_1$Qm3 == '2', 2, 
                                                          (ifelse (RECORD_w1_1$Qm3 == '3', 3,        
                                                            (ifelse (RECORD_w1_1$Qm3 == '4', 4,      
                                                             (ifelse (RECORD_w1_1$Qm3 == '5', 5,     
                                                               (ifelse (RECORD_w1_1$Qm3 == '6', 6,   
                                                                 (ifelse (RECORD_w1_1$Qm3 == '7', 7, 
                                                                    (ifelse (RECORD_w1_1$Qm3 == '8', 8, 
                                                                      (ifelse (RECORD_w1_1$Qm3 == '9', 9, 
                                                                         (ifelse (RECORD_w1_1$Qm3 == '10', 10, 
                                                                           (ifelse (RECORD_w1_1$Qm3 == '11', 11, 
                                                                             (ifelse (RECORD_w1_1$Qm3 == '12', 12, 
                                                                               (ifelse (RECORD_w1_1$Qm3 == '13', 13, 
                                                                                 (ifelse (RECORD_w1_1$Qm3 == '14', 14, 
                                                                                    (ifelse (RECORD_w1_1$Qm3 == '15', 15, 
                                                                 NA))))))))))))))))))))))))))))))))
table(soc_RECORD_0$soc_sn_num_children_0) 
summary(soc_RECORD_0$soc_sn_num_children_0) 
...
**Harmonization status**:  complete
**Harmonization comment**:  Numbers above 15 set as NA, note many NAs. Non-whole numbers set as NA.   RECORD does not ask what type of child respondent has.  
**R script**:  
```{r, echo=TRUE}
table(RECORD_w2$Qm137) 
soc_RECORD_1$soc_sn_num_children_1 <- as.integer(ifelse(RECORD_w2$Qm137 == '0', 0, 
                                                   (ifelse (RECORD_w2$Qm137 == '1', 1,
                                                        (ifelse (RECORD_w2$Qm137 == '2', 2, 
                                                          (ifelse (RECORD_w2$Qm137 == '3', 3,        
                                                            (ifelse (RECORD_w2$Qm137 == '4', 4,      
                                                             (ifelse (RECORD_w2$Qm137 == '5', 5,     
                                                               (ifelse (RECORD_w2$Qm137 == '6', 6,   
                                                                 (ifelse (RECORD_w2$Qm137 == '7', 7, 
                                                                    (ifelse (RECORD_w2$Qm137 == '8', 8, 
                                                                      (ifelse (RECORD_w2$Qm137 == '9', 9, 
                                                                         (ifelse (RECORD_w2$Qm137 == '10', 10, 
                                                                           (ifelse (RECORD_w2$Qm137 == '11', 11, 
                                                                             (ifelse (RECORD_w2$Qm137 == '12', 12, 
                                                                               (ifelse (RECORD_w2$Qm137 == '13', 13, 
                                                                                 (ifelse (RECORD_w2$Qm137 == '14', 14, 
                                                                                    (ifelse (RECORD_w2$Qm137 == '15', 15, 
                                                                 NA))))))))))))))))))))))))))))))))
table(soc_RECORD_1$soc_sn_num_children_1) 
summary(soc_RECORD_1$soc_sn_num_children_1) 
#4337 missings! reminder to ask Basile why
```
### **Variable label**:   Network size of children      
...
**R script**:  
```{r, echo=TRUE}
table(RECORD_w1_1$Qm3) # WOW incredible answers data NOT clean 
summary(RECORD_w1_1$Qm3)

soc_RECORD_0$soc_sn_children_rank_0 <- as.integer(ifelse(RECORD_w1_1$Qm3 == '0', 0, 
                                                   (ifelse ((RECORD_w1_1$Qm3 == '1' | RECORD_w1_1$Qm3 == '2') , 1,
                                                          (ifelse (RECORD_w1_1$Qm3 == '3', 2,        
                                                            (ifelse (RECORD_w1_1$Qm3 == '4', 2,      
                                                             (ifelse (RECORD_w1_1$Qm3 == '5', 2,     
                                                               (ifelse (RECORD_w1_1$Qm3 == '6', 2,   
                                                                 (ifelse (RECORD_w1_1$Qm3 == '7', 2, 
                                                                    (ifelse (RECORD_w1_1$Qm3 == '8', 2, 
                                                                      (ifelse (RECORD_w1_1$Qm3 == '9', 2, 
                                                                         (ifelse (RECORD_w1_1$Qm3 == '10', 2, 
                                                                           (ifelse (RECORD_w1_1$Qm3 == '11', 2, 
                                                                             (ifelse (RECORD_w1_1$Qm3 == '12', 2, 
                                                                               (ifelse (RECORD_w1_1$Qm3 == '13', 2, 
                                                                                 (ifelse (RECORD_w1_1$Qm3 == '14', 2, 
                                                                                    (ifelse (RECORD_w1_1$Qm3 == '15', 2, 
                                                                 NA))))))))))))))))))))))))))))))
table(soc_RECORD_0$soc_sn_children_rank_0) 
summary(soc_RECORD_0$soc_sn_children_rank_0) 
...
```{r, echo=TRUE}
table(RECORD_w2$Qm137) 
soc_RECORD_1$soc_sn_children_rank_1 <- as.integer(ifelse(RECORD_w2$Qm137 == '0', 0, 
                                                   (ifelse (RECORD_w2$Qm137 == '1', 1,
                                                        (ifelse (RECORD_w2$Qm137 == '2', 1, 
                                                          (ifelse (RECORD_w2$Qm137 == '3', 2,        
                                                            (ifelse (RECORD_w2$Qm137 == '4', 2,      
                                                             (ifelse (RECORD_w2$Qm137 == '5', 2,     
                                                               (ifelse (RECORD_w2$Qm137 == '6', 2,   
                                                                 (ifelse (RECORD_w2$Qm137 == '7', 2, 
                                                                    (ifelse (RECORD_w2$Qm137 == '8', 2, 
                                                                      (ifelse (RECORD_w2$Qm137 == '9', 2, 
                                                                         (ifelse (RECORD_w2$Qm137 == '10', 2, 
                                                                           (ifelse (RECORD_w2$Qm137 == '11', 2, 
                                                                             (ifelse (RECORD_w2$Qm137 == '12', 2, 
                                                                               (ifelse (RECORD_w2$Qm137 == '13', 2, 
                                                                                 (ifelse (RECORD_w2$Qm137 == '14', 2, 
                                                                                    (ifelse (RECORD_w2$Qm137 == '15', 2, 
                                                                 NA))))))))))))))))))))))))))))))))
table(soc_RECORD_1$soc_sn_children_rank_1) 
summary(soc_RECORD_1$soc_sn_children_rank_1) 
...
**R script**:  
```{r, echo=TRUE}
# can we use q2_no_amiproch ? I do not think so since it is not continous 
summary(soc_RECORD_0$soc_sn_num_children_0)
soc_RECORD_0$soc_sn_num_network_all_0 <- quantile(soc_RECORD_0$soc_sn_num_children_0,probs= c(0.25,0.50, 0.75), na.rm = TRUE)   
table(soc_RECORD_0$soc_sn_num_network_all_0)
...
# can we use q2_no_amiproch ? I do not think so since it is not continous 
summary(soc_RECORD_1$soc_sn_num_children_1)
soc_RECORD_1$soc_sn_num_network_all_1 <- quantile(soc_RECORD_1$soc_sn_num_children_1,probs= c(0.25,0.50, 0.75), na.rm = TRUE)
table(soc_RECORD_1$soc_sn_num_network_all_1)
...
**R script**:  
```{r, echo=TRUE}
table(RECORD_w1_1$Q24_d_1) # 1= Participate in religious organization in neighbourhood...
table(RECORD_w1_1$Q24_d_2) # 1= Participate in religious organization outside neighbourhood ...unfortunately the rest is coded as NA
table(RECORD_w1_1$Q24_d_3) # 1= Participate in religious organization in and outside neighbourhood ... unfortunately the rest is coded as NA
table(RECORD_w1_1$Q24_d_4) # 1= Does not participate in religious organization
typeof(RECORD_w1_1$Q24_d_1)
...
table(RECORD_w1_1$soc_sp_religious_0_inter)
summary(RECORD_w1_1$soc_sp_religious_0_inter)
...
table(soc_RECORD_0$soc_sp_religious_0) 
summary(soc_RECORD_0$soc_sp_religious_0) 
...
**R script**:  
```{r, echo=TRUE}
table(RECORD_w1_1$Q24_b_1) # 1= Participate in aid or humanitarian  organization in neighbourhood
table(RECORD_w1_1$Q24_b_2) # 1= Participate in aid or humanitarian  organization outside neighbourhood
table(RECORD_w1_1$Q24_b_3) # 1= Participate in aid or humanitarian  organization in and outside neighbourhood
table(RECORD_w1_1$Q24_b_4) # 1= Does not participate in aid or humanitarian organization

RECORD_w1_1$soc_sp_volunteer_0_inter <- ifelse(RECORD_w1_1$Q24_b_1=='0' & is.na(RECORD_w1_1$Q24_b_2) &      
                                                 is.na(RECORD_w1_1$Q24_b_3),0, 
                 ifelse(RECORD_w1_1$Q24_b_1=='1' | RECORD_w1_1$Q24_b_2=='1' | RECORD_w1_1$Q24_b_3=='1',1,NA))
table(RECORD_w1_1$soc_sp_volunteer_0_inter)
summary(RECORD_w1_1$soc_sp_volunteer_0_inter)

soc_RECORD_0$soc_sp_volunteer_0 <- ifelse(RECORD_w1_1$soc_sp_volunteer_0_inter == 0 & RECORD_w1_1$Q24_b_4 == '1',0, ifelse(RECORD_w1_1$soc_sp_volunteer_0_inter == 1 & is.na(RECORD_w1_1$Q24_b_4),1, NA))

table(soc_RECORD_0$soc_sp_volunteer_0) 
summary(soc_RECORD_0$soc_sp_volunteer_0) 
```
### **Variable label**:  Volunteering      
...
**R script**:  
```{r, echo=TRUE}
table(RECORD_w1_1$Q24_a_1) # 1= Participate in union or political party in neighbourhood
table(RECORD_w1_1$Q24_a_2) # 1= Participate in union or political party outside neighbourhood
table(RECORD_w1_1$Q24_a_3) # 1= Participate in union or political party outside neighbourhood
table(RECORD_w1_1$Q24_a_4) # 1= Does not participate in union or political party 
...
table(RECORD_w1_1$soc_sp_pol_0_inter)
summary(RECORD_w1_1$soc_sp_pol_0_inter)
...
table(soc_RECORD_0$soc_sp_pol_0) 
summary(soc_RECORD_0$soc_sp_pol_0)
...
**Harmonization status**:  complete
**Harmonization comment**: Composed of RECORD's items Q24_e_1/2/3 which asks about participation and the dataschemas: soc_sp_religious_0 soc_sp_volunteer_0 soc_sp_pol_0. 
**R script**:  
```{r, echo=TRUE}
table(RECORD_w1_1$Q24_e_1) # 1= Participates other association in neighbourhood
table(RECORD_w1_1$Q24_e_2) # 1= Participates other association outside neighbourhood
table(RECORD_w1_1$Q24_e_3) # 1= Participates other association in and outside neighbourhood
# if 0 to all these and 0 to the ones we did already then 0 as a participation 
...
table(RECORD_w1_1$soc_sp_general_0_inter)
summary(RECORD_w1_1$soc_sp_general_0_inter)
...
#above, if I kept RECORD_w1_1$soc_sp_general_0_inter == 0  as well, wouldnt make a diff

# if I reverse and put xxx==0 first then I get other answer 
#soc_RECORD_0$soc_sp_general_0 <- ifelse(RECORD_w1_1$soc_sp_general_0_inter == 0 | soc_RECORD_0$soc_sp_religious_0 == 0 | soc_RECORD_0$soc_sp_volunteer_0 == 0 | soc_RECORD_0$soc_sp_pol_0 == 0,0, 
#                                 ifelse(RECORD_w1_1$soc_sp_general_0_inter == 0 | soc_RECORD_0$soc_sp_religious_0 == 1 | #soc_RECORD_0$soc_sp_volunteer_0 == 1 | soc_RECORD_0$soc_sp_pol_0 == 1, 1, NA))

table(soc_RECORD_0$soc_sp_general_0) 
summary(soc_RECORD_0$soc_sp_general_0)
...
**Harmonization status**:  complete
**Harmonization comment**: composed of RECORD's item Q5_e that asks if the participant has no friends and soc_sp_general_0
**R script**:  
```{r, echo=TRUE}
table(RECORD_w1_1$Q5_e) #=1 = has no friends plus the general variable above 
table(soc_RECORD_0$soc_sp_general_0) #0= no participation 
...
summary(soc_RECORD_0$soc_sp_isolation_0)
...
**R script**:  
```{r, echo=TRUE}
table(RECORD_w1_1$Q52)

soc_RECORD_0$soc_res_num_yrsnbh_0 <- as.integer(RECORD_w1_1$Q52)
table(soc_RECORD_0$soc_res_num_yrsnbh_0) 
summary(soc_RECORD_0$soc_res_num_yrsnbh_0) 
...
table(soc_RECORD_0$soc_res_num_yrshome_0) 
summary(soc_RECORD_0$soc_res_num_yrshome_0) 
...
**Harmonization status**:  complete
**Harmonization comment**: RECORD asks the reverse of the DataSchema:  will participant continue to live in their neighborhood in the futur?  
**R script**:  
```{r, echo=TRUE}
table(RECORD_w1_2$q13_contiviv)   # 1= I will continue to live in my neighborhood in the future

soc_RECORD_0$soc_res_satis_0 <- as.integer(ifelse(RECORD_w1_2$q13_contiviv == '1', 0,                                            
                                                 (ifelse (RECORD_w1_2$q13_contiviv == '0', 1, NA))))
table(soc_RECORD_0$soc_res_satis_0) 
summary(soc_RECORD_0$soc_res_satis_0) 
...
**R script**:  
```{r, echo=TRUE}
table(RECORD_w2$Q5_Demenagement_prevu) #1 yes i want to move 2 = no 3 = i don't know 
summary(RECORD_w2$Q5_Demenagement_prevu) 
sum(is.na(RECORD_w2$Q5_Demenagement_prevu))
...
table(soc_RECORD_1$soc_res_satis_1) 
summary(soc_RECORD_1$soc_res_satis_1) 
...
**R script**:  
```{r, echo=TRUE}
table(RECORD_w2$P58_Q3_1240) #1= household owner 
table(RECORD_w2$P58_Q3_1241) #1 = not a household owner 
soc_RECORD_1$soc_res_home_own_dich_1 <- as.integer(ifelse(RECORD_w2$P58_Q3_1240 == 1, 1,
                                                 (ifelse (RECORD_w2$P58_Q3_1241 == 1, 0, NA))))
table(soc_RECORD_1$soc_res_home_own_dich_1) 
summary(soc_RECORD_1$soc_res_home_own_dich_1) 
