...
**R script**:  
```{r, echo=TRUE}
soc_RECORD_0$soc_sn_children_rank_0_test <- as.integer(ifelse(RECORD_w1_1$Qm3==0,0L, ifelse(RECORD_w1_1$Qm3==1 | RECORD_w1_1$Qm3==2,1L, ifelse(RECORD_w1_1$Qm3 %in% c(3:15),2L,NA))))
...
**R script**:  
```{r, echo=TRUE}
soc_RECORD_0$soc_ss_received_emo_0<-NA
soc_RECORD_0$soc_ss_received_emo_0[(RECORD_w1_2$q6_no_voisserv==4|RECORD_w1_2$q6_no_voisserv==3)&(RECORD_w1_2$q23_no_aideexte==4|RECORD_w1_2$q23_no_aideexte==3)&(RECORD_w1_2$q23_no_aidemnge==4|RECORD_w1_2$q23_no_aidemnge==3)]<-0
soc_RECORD_0$soc_ss_received_emo_0[RECORD_w1_2$q6_no_voisserv==1|RECORD_w1_2$q23_no_aideexte==1|RECORD_w1_2$q23_no_aidemnge==1]<-2
soc_RECORD_0$soc_ss_received_emo_0[RECORD_w1_2$q6_no_voisserv==2|RECORD_w1_2$q23_no_aideexte==2|RECORD_w1_2$q23_no_aidemnge==2]<-1
...
table(RECORD_w1_1$humanitarian)
...
**R script**:  
```{r, echo=TRUE}
table(RECORD_w1_1$Q5_e, useNA = "always") #=1 = has no friends plus the general variable above 
table(soc_RECORD_0$soc_sp_general_0, useNA = "always") #0= no participation 
