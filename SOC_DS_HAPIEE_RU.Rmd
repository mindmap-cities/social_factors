...
soc_HAPIEE_RU_0$soc_sn_freq_friends_inperson_0 <-  ifelse(HAPIEE_W1$p58=='1',2L, 
                                                     ifelse(HAPIEE_W1$p58=='2' | HAPIEE_W1$p58=='3',3L,
                                                       ifelse(HAPIEE_W1$p58 =='4',4L, 
                                                         ifelse(HAPIEE_W1$p58 =='5' | HAPIEE_W1$p58 =='5',5L,NA))))

table(soc_HAPIEE_RU_0$soc_sn_freq_friends_inperson_0) 
...
table(soc_HAPIEE_RU_0$soc_sn_freq_relatives_0)
```
### **Variable label**:   Contact frequency with relatives      
...
table(soc_HAPIEE_RU_0$soc_sp_general_0)
