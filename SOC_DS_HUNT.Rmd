...
# HUNT2
opal.assign.table.tibble(erasmus_opal, 'HUNT2', 'HUNT.HUNT2', variables=list('HouTyp_NT2BLQ2')) 
...
**Harmonization comment**: DelivN@NT2BLQ2 only refers to biological children and excludes other types.   
**R script**:  
```{r, echo=TRUE}
...
**Harmonization status**: impossible    
**Harmonization comment**: Initially I thought I can add HUNT's variable either but per Dany's email on 14-6, would this be incorrect? bc other cohorts would have more kids since they ask about e.g. adopted kids
**R script**:  
```{r, echo=TRUE}
#This is where the R-script will be written
...
env_HUNT_1$soc_res_type_1<-recode(as.integer(HUNT2$HouTyp_NT2BLQ2),'1'=2L,'2'=4L,'3'=1L,'4'=2L,'5'=3L, '6'=3L,'7'=5L)
